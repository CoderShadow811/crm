          ...
          <b-tbody>
            <b-tr v-for="user in users" :key="user.id">
              <b-td class="text-center">
                <img class="img-avatar img-avatar48" :src="`ennobledesign.co/wp-content/uploads/2020/07/user.png`" alt="Avatar">
              </b-td>
             ...
             {{ user.mail}}
              ...
              <b-td>
                <b-badge :variant="'success'">{{ user.rol}}</b-badge>
              </b-td>
              <b-td class="text-center">
...
export default {
  ...
  methods:{
    ...mapActions(['getUsers','eliminarTarea'])
  },
  created(){
    this.getUsers()
